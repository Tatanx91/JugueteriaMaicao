...
<div class="row" >
	...
	<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
		...
		{!! Form::text('NombreUsuario', $administrador->NombreUsuario, array('id' => 'NombreUsuario', 'class'=> 'form-control', 'placeholder' => 'Nombre del usuario')) !!}
	...
	<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
		...
		{!! Form::text('NumeroDocumento', $administrador->NumeroDocumento, array('id' => 'NumeroDocumento', 'class'=> 'form-control', 'placeholder' => 'Numero de documento')) !!}
